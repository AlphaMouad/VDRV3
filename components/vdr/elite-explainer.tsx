  ...
  return (
    <span className="relative inline" ref={ref}>
      <button
        ...
        className="inline-flex items-center gap-1 border-b border-dashed border-[rgba(212,175,55,0.5)] text-[#D4AF37] hover:text-[#DFBD69] hover:border-[#DFBD69] transition-colors duration-200 cursor-help"
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="bg-[#0c0c0c] border border-[rgba(212,175,55,0.25)] rounded-lg shadow-2xl shadow-black/60 overflow-hidden">
              {/* Header */}
              <div className="flex items-center justify-between px-4 py-3 bg-[rgba(212,175,55,0.06)] border-b border-[rgba(212,175,55,0.15)]">
