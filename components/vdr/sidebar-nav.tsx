  ...
  return (
    <>
      ...
      <button
        ...
        onMouseEnter={e => {
          (e.currentTarget as HTMLButtonElement).style.borderColor = "rgba(197,160,89,0.45)"
          ;(e.currentTarget as HTMLButtonElement).style.boxShadow = "0 2px 12px rgba(0,0,0,0.7), 0 0 10px rgba(197,160,89,0.15)"
        }}
        onMouseLeave={e => {
      ...
      >
        {mobileOpen
          ? <X className="w-[15px] h-[15px] text-[#C5A059]" />
          : <Menu className="w-[15px] h-[15px] text-[#C5A059]" />}
      </button>
      ...
      >
        ...
        <div style={{ padding: "28px 24px 0 24px" }}>
          ...
          <div style={{
            height: "1px",
            background: "linear-gradient(90deg, rgba(197,160,89,0.35) 0%, rgba(197,160,89,0.18) 60%, transparent 100%)",
            marginBottom: "16px",
          }} />
          <p style={{
        ...
        <div style={{ padding: "0 24px 20px 24px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "8px" }}>
            ...
            <span style={{ fontFamily: "var(--font-jetbrains)", fontSize: "10px", color: "#C5A059", fontWeight: 600 }}>
              {progressPct}%
            </span>
          </div>
          <div style={{
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: isActive ? "rgba(197,160,89,0.065)" : undefined,
                  border: isActive ? "1px solid rgba(197,160,89,0.14)" : "1px solid transparent",
                }}
              >
                ...
                {isActive && (
                  <motion.div
                    ...
                    style={{
                      ...
                      background: "linear-gradient(180deg, #D4AF70, #C5A059, #A87E2A)",
                ...
                <Icon style={{
                  ...
                  color: isActive ? "#C5A059" : "currentColor",
        ...
        <div style={{ padding: "0 12px 12px 12px" }}>
          <button
            ...
            style={{
              padding: "12px 16px",
              background: "linear-gradient(135deg, #D4AF70 0%, #C5A059 50%, #9A7B3E 100%)",
              boxShadow: "0 0 24px rgba(197,160,89,0.28), 0 2px 8px rgba(0,0,0,0.5)",
