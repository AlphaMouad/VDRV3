      ...
      <Reveal delay={0.1}>
        <div className="glass-form p-6 mb-6">
          <div className="flex items-center gap-2 mb-4">
            <Receipt style={{ width: "13px", height: "13px", color: "#C5A059", flexShrink: 0 }} />
            ...
            {flowSteps.map((step, i) => (
              <div key={step.label} className="flex items-start">
                <div className="flex flex-col items-center text-center flex-1 min-w-0">
                  ...
                  <span className="text-[11px] text-[#C5A059] font-mono mb-1">{step.month}</span>
            ...
            {flowSteps.map((step, i) => (
              <div key={step.label}>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="text-[11px] text-[#C5A059] font-mono">{step.month}</span>
        ...
        <div className="glass-form p-6">
          ...
          <div className="flex flex-col gap-3">
            {documents.map((doc) => (
              <div
                key={doc.file}
                className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-0 sm:justify-between p-4 rounded-lg bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)] hover:border-[rgba(197,160,89,0.2)] transition-all duration-300 group"
              >
