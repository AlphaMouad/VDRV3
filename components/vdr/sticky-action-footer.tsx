  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: "0 -20px 52px -10px rgba(0,0,0,0.98), 0 -1px 0 rgba(197,160,89,0.06)",
      }}
    >
      {/* Gold hairline top */}
      <div style={{
        ...
        background: "linear-gradient(90deg, transparent 0%, rgba(197,160,89,0.15) 30%, rgba(197,160,89,0.28) 50%, rgba(197,160,89,0.15) 70%, transparent 100%)",
      }} />
      ...
      <div className="hidden sm:flex items-center gap-2.5 shrink-0 mr-5">
        <span style={{
          ...
          boxShadow: "0 0 7px rgba(197,160,89,0.75)", flexShrink: 0,
        }} />
        <span
          ...
          {[...ticker, ...ticker].map((item, i) => (
            <div key={i} className="flex items-center gap-2.5">
              <span style={{
                ...
                background: "rgba(197,160,89,0.45)", flexShrink: 0,
      ...
      <button
        ...
        style={{
          borderRadius: "8px",
          padding: "10px 18px",
          background: "linear-gradient(135deg, #D4AF70 0%, #C5A059 45%, #9A7B3E 100%)",
          border: "1px solid rgba(197,160,89,0.5)",
          boxShadow: "0 0 18px rgba(197,160,89,0.25), 0 2px 8px rgba(0,0,0,0.5)",
        }}
        onMouseEnter={e => {
          (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 0 28px rgba(197,160,89,0.4), 0 4px 16px rgba(0,0,0,0.6)"
          ;(e.currentTarget as HTMLButtonElement).style.transform = "translateY(-1px)"
        }}
        onMouseLeave={e => {
          (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 0 18px rgba(197,160,89,0.25), 0 2px 8px rgba(0,0,0,0.5)"
